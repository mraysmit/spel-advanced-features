...
public class RulesEngineConfiguration {
    ...
    private final Map<Category, List<com.rulesengine.core.engine.RuleBase>> rulesByCategory = new HashMap<>();
    private final Map<String, com.rulesengine.core.engine.Rule> rulesById = new HashMap<>();
    private final Map<String, com.rulesengine.core.engine.RuleGroup> ruleGroupsById = new HashMap<>();
     ...
     */
    public com.rulesengine.core.engine.Rule registerRule(com.rulesengine.core.engine.Rule rule) {
     ...
     */
    private void addRuleToCategory(com.rulesengine.core.engine.RuleBase rule, Category category) {
     ...
     */
    private void addRuleToCategory(com.rulesengine.core.engine.RuleBase rule, String categoryName) {
    ...
    public boolean addRuleToGroup(String groupId, String ruleId, int sequenceNumber) {
        com.rulesengine.core.engine.RuleGroup group = ruleGroupsById.get(groupId);
        if (group == null) {
            LOGGER.warning("Rule group with ID '" + groupId + "' not found");
            return false;
        }

        com.rulesengine.core.engine.Rule rule = rulesById.get(ruleId);
        if (rule == null) {
    ...
    private void sortRulesByPriority(Category category) {
        List<com.rulesengine.core.engine.RuleBase> rules = rulesByCategory.get(category);
        if (rules != null) {
            rules.sort(Comparator.comparingInt(com.rulesengine.core.engine.RuleBase::getPriority));
        }
    }
     ...
     */
    public com.rulesengine.core.engine.Rule combineWithAnd(String id, Category category, String name, List<com.rulesengine.core.engine.Rule> rules,
     ...
     * @return The newly created rule, or null if no rules to combine
     */
    public com.rulesengine.core.engine.Rule combineWithAnd(String id, String categoryName, String name, List<com.rulesengine.core.engine.Rule> rules,
                                                           String message, String description, int priority) {
        Category category = getCategoryByName(categoryName);
     ...
     * @return The newly created rule, or null if no rules to combine
     */
    public com.rulesengine.core.engine.Rule combineWithOr(String id, Category category, String name, List<com.rulesengine.core.engine.Rule> rules,
                                                          String message, String description, int priority) {
        if (rules == null || rules.isEmpty()) {
            LOGGER.warning("No rules to combine");
            return null;
     ...
     * @return The newly created rule, or null if no rules to combine
     */
    public com.rulesengine.core.engine.Rule combineWithOr(String id, String categoryName, String name, List<com.rulesengine.core.engine.Rule> rules,
                                                          String message, String description, int priority) {
        Category category = getCategoryByName(categoryName);
     ...
     */
    public com.rulesengine.core.engine.RuleGroup registerRuleGroup(com.rulesengine.core.engine.RuleGroup group) {
     ...
     */
    public List<com.rulesengine.core.engine.RuleBase> getRulesForCategory(Category category) {
     ...
     * @return The list of rules for the category
     */
    public List<com.rulesengine.core.engine.RuleBase> getRulesForCategory(String categoryName) {
        Category category = getCategoryByName(categoryName);
     ...
     */
    public com.rulesengine.core.engine.Rule getRuleById(String id) {
        com.rulesengine.core.engine.Rule rule = rulesById.get(id);
        if (rule == null) {
     ...
     */
    public com.rulesengine.core.engine.RuleGroup getRuleGroupById(String id) {
        com.rulesengine.core.engine.RuleGroup group = ruleGroupsById.get(id);
        if (group == null) {
     ...
     */
    public com.rulesengine.core.engine.RuleGroup createRuleGroupWithAnd(String id, Category category, String name,
                                                                        String description, int priority) {
        com.rulesengine.core.engine.RuleGroup group = group(id)
            .withCategory(category)
            .withName(name)
            .withDescription(description)
            .withPriority(priority)
     ...
     * @return The newly created rule group
     */
    public com.rulesengine.core.engine.RuleGroup createRuleGroupWithAnd(String id, String categoryName, String name,
                                                                        String description, int priority) {
        Category category = getCategoryByName(categoryName);
     ...
     * @return The newly created rule group
     */
    public com.rulesengine.core.engine.RuleGroup createRuleGroupWithAnd(String id, Set<String> categoryNames, String name,
                                                                        String description, int priority) {
        com.rulesengine.core.engine.RuleGroup group = group(id)
     ...
     * @return The newly created rule group
     */
    public com.rulesengine.core.engine.RuleGroup createRuleGroupWithOr(String id, Category category, String name,
                                                                       String description, int priority) {
        com.rulesengine.core.engine.RuleGroup group = group(id)
            .withCategory(category)
            .withName(name)
     ...
     * @return The newly created rule group
     */
    public com.rulesengine.core.engine.RuleGroup createRuleGroupWithOr(String id, String categoryName, String name,
                                                                       String description, int priority) {
        Category category = getCategoryByName(categoryName);
     ...
     * @return The newly created rule group
     */
    public com.rulesengine.core.engine.RuleGroup createRuleGroupWithOr(String id, Set<String> categoryNames, String name,
                                                                       String description, int priority) {
        com.rulesengine.core.engine.RuleGroup group = group(id)
            .withCategoryNames(categoryNames)
            .withName(name)
    ...
    public String combineRulesWithAnd(String id, Category category, String name, List<String> ruleIds,
        ...
        List<com.rulesengine.core.engine.Rule> rules = new ArrayList<>();
        for (String ruleId : ruleIds) {
            com.rulesengine.core.engine.Rule rule = getRuleById(ruleId);
            if (rule == null) {
                LOGGER.warning("Rule with ID '" + ruleId + "' not found");
                return null;
            }
        ...
        com.rulesengine.core.engine.Rule combinedRule = combineWithAnd(id, category, name, rules, message, description, priority);
    ...
    public String combineRulesWithOr(String id, Category category, String name, List<String> ruleIds,
        ...
        com.rulesengine.core.engine.Rule combinedRule = combineWithOr(id, category, name, rules, message, description, priority);
        if (combinedRule != null) {
            registerRule(combinedRule);
            return combinedRule.getId();
        }
